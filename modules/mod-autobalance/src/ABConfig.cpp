...
uint8         PlayerCountDifficultyOffsetApplyAtOrBelowPlayers;
...
int8 GetEffectivePlayerCountDifficultyOffset(uint8 actualPlayerCount)
{
    if (!PlayerCountDifficultyOffset)
        return 0;

    if (PlayerCountDifficultyOffsetApplyAtOrBelowPlayers > 0 &&
        actualPlayerCount > PlayerCountDifficultyOffsetApplyAtOrBelowPlayers)
        return 0;

    return PlayerCountDifficultyOffset;
}
